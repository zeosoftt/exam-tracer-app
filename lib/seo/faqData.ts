...
export const PUBLIC_FAQ_ITEMS = [
  {
    q: 'The Goal Lab gerçekten ücretsiz mi?',
    a: 'Evet. Sınav, ders ve konu takibi; dashboard ve temel ilerleme istatistikleri ücretsiz planda kullanılabilir. Kredi kartı gerekmez.',
  },
  {
  ...
  },
  {
    ...
    a: 'Hesabınıza özel veriler izole tutulur. Giriş şifreli oturumlarla korunur; verileriniz başka kullanıcılarla paylaşılmaz.',
  },
  {
    q: 'Mobil cihazlardan kullanabilir miyim?',
    a: 'Evet. The Goal Lab mobil uyumludur; telefon ve tabletten tarayıcı üzerinden rahatça kullanabilirsiniz.',
  },
  {
    q: 'Kurumsal veya dershane kullanımı var mı?',
    a: 'Evet. Rol yönetimi ve merkezi görünürlük ile sınıf veya şube bazlı takip için kurumsal planlar mevcuttur. Destek sayfasından iletişime geçebilirsiniz.',
  },
] as const;

...
export default function GlobalError({ error, reset }: ErrorPageProps) {
  ...
  return (
    <html lang="tr">
      <body className="flex min-h-screen items-center justify-center bg-stone-50 px-4 dark:bg-stone-950">
        <div className="max-w-md rounded-2xl border border-stone-200 bg-white p-8 text-center shadow-sm dark:border-stone-800 dark:bg-stone-900">
          ...
          <p className="mt-2 text-sm text-stone-600 dark:text-stone-400">
            Sayfayı yenilemeyi deneyin. Sorun devam ederse destek ekibine ulaşın.
          </p>

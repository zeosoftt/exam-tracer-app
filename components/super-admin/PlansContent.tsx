      ...
      <header className="border-b border-gray-200 bg-white/90 backdrop-blur-sm shadow-sm">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <h1 className="text-lg font-semibold text-gray-900">Planlar & Abonelikler</h1>
            <div className="w-28" />
          </div>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-500 mt-0.5">FREE / PRO / ENTERPRISE dağılımı</p>
          </div>
          {loading ? (
            ...
            <div className="p-8 text-center text-gray-500 text-sm">Henüz plan verisi yok.</div>
          ) : (
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm">
                ...
                <tbody>
                  {planStats.map((p) => (
                    <tr key={p.planId ?? p.planCode} className="border-t border-gray-100 hover:bg-gray-50/50">
                      ...
                      <td className="px-4 py-3 text-gray-700">{p.planType}</td>
                      <td className="px-4 py-3 text-gray-900 font-semibold">{p.userCount}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
